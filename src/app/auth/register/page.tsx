    ...
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(19,33,66,0.95),_#08111f_55%,_#030712_100%)] px-6 py-12 text-white">
      <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(10,18,34,0.94),rgba(6,12,24,0.88))] p-8 shadow-2xl backdrop-blur">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.22em] text-cyan-200/70">Conta nova</p>
        ...
        <p className="mt-3 text-sm text-slate-300">
          Cadastro simples para liberar compra, checkout e acompanhamento do cliente no mesmo fluxo.
        </p>
        ...
        <p className="mt-4 text-xs text-slate-400">
          A senha precisa ter ao menos 8 caracteres. A conta ja sai com sessao autenticada.
        </p>
        <p className="mt-2 text-xs uppercase tracking-[0.18em] text-slate-400">Versao {APP_VERSION}</p>
